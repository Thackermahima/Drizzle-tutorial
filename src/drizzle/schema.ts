...
import  { pgTable, varchar, uuid, integer, pgEnum, unique, uniqueIndex, boolean, real, timestamp, primaryKey} from "drizzle-orm/pg-core"
...
// One : One Relationship with foreign key 
